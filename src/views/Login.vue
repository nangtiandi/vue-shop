    ...
    <div class="row my-5">
      <div class="col-md-12">
        <div class="d-lg-flex half">
          <div class="bg order-1 order-md-2" style="background-attachment: fixed;background-image: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQCeOaG_JGABZOdsAW04c1vEGgrMr0Nf4jRAy9pU2DVos292hJ04UT-yUAirFz6r1CKwvo&usqp=CAU);"></div>
