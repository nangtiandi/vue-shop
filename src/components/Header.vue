        ...
        <div class="row">
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="section-title mb-0">
              <h2>One Slove on one time.</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eligendi facilis hic maxime perferendis reprehenderit repudiandae suscipit temporibus totam. Debitis earum facere laudantium neque nesciunt officia quas reiciendis repellat vero voluptas?. </p>
            </div>
          </div>
        </div>
      </div>
